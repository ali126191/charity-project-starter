...
const Footer = () => {
  return (
    <section id='footer' className='section block is-vcentered' >
      <div className='container'>
        <h3 className='block has-text-centered is-size-4 is-uppercase has-text-weight-semibold is-large has-text-white'>
